...
<head>
    ...
    <title>Chi Tiết Người Dùng : <?= $comments['name'] ?></title>
...
<body>
    <div class="container">
        ...
        <h1 style="margin-top:50px">Chi Tiết Comment : <?= $comment['id_comment'] ?></h1>
        <table>
            <tr>
                <th>Tên Trường</th>
                <th>Giá Trị</th>
        ...
        <a style="color:blue;" href="<?= BASE_URL_ADM . '?act=comments'  ?>"><button>Back to List comments</button></a>
