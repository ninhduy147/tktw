            ...
            <div class="card-body p-5 text-center">
              ...
              <form action="" method="POST">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input placeholder="Email" name="email" type="email" id="typeEmailX-2" class="form-control form-control-lg" />
                </div>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input placeholder="Password" name="password" type="password" id="typePasswordX-2" class="form-control form-control-lg" />
                </div>
